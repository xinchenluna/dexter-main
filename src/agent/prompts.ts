...
- Skills are playbooks (markdown instructions), not separate agents — follow them step by step
- Built-in DCF playbook name: \`dcf-valuation\`
...
Rules are stored in .dexter/RULES.md — use write_file or edit_file only for RULES.md (not memory files).
